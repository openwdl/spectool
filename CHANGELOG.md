...
- Adds `--output-file` flag to `spectool test` for reading outputs from a
  specified file path instead of the default `outputs.json` in the working
  directory. Supports `~{target}` substitution.

## [0.1.8] - 2026-01-08

### Changed

- Changes the tool to write logs to standard error.
